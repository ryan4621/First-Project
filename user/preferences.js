...
export function initializePreferences() {
	...
	function populatePreferenceFields(preferences) {
		...
		document.getElementById("preferences-notifications-email").checked =
			preferences.notifications_email;
		document.getElementById("preferences-notifications-sms").checked =
			preferences.notifications_sms;
		document.getElementById("preferences-notifications-push").checked =
			preferences.notifications_push;
		document.getElementById("preferences-marketing-emails").checked =
			preferences.marketing_emails;
		document.getElementById("preferences-order-updates").checked =
			preferences.order_updates;
		document.getElementById("preferences-promotional-offers").checked =
			preferences.promotional_offers;

		// Language & Currency
		document.getElementById("preferences-language-select").value =
			preferences.language || "en";
		document.getElementById("preferences-currency-select").value =
			preferences.currency || "USD";

		// Privacy settings
		document.getElementById("preferences-profile-visibility").value =
			preferences.profile_visibility || "public";
		document.getElementById("preferences-show-online-status").checked =
			preferences.show_online_status;
		document.getElementById("preferences-allow-search-engines").checked =
			preferences.allow_search_engines;
	}
	...
	async function saveUserPreferences() {
		try {
			...
			const preferencesData = {
				notifications_email: document.getElementById(
					"preferences-notifications-email"
				).checked,
				notifications_sms: document.getElementById(
					"preferences-notifications-sms"
				).checked,
				notifications_push: document.getElementById(
					"preferences-notifications-push"
				).checked,
				marketing_emails: document.getElementById(
					"preferences-marketing-emails"
				).checked,
				order_updates: document.getElementById("preferences-order-updates")
					.checked,
				promotional_offers: document.getElementById(
					"preferences-promotional-offers"
				).checked,
				...
				profile_visibility: document.getElementById(
					"preferences-profile-visibility"
				).value,
				show_online_status: document.getElementById(
					"preferences-show-online-status"
				).checked,
				allow_search_engines: document.getElementById(
					"preferences-allow-search-engines"
				).checked,
			};
