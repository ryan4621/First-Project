...
function createProductElement(product) {
    ...
    <div class="shop-item-details">
      <div class="rec-item-details">
        ...
        <p class="rec-item-details-name shop-item-title" style="font-weight: bold">${
					product.name
				}</p>
...
async function addToCartClicked(event) {
	...
	var cartTag =
		shopItem.getElementsByClassName("shop-item-tag")[0]?.innerText || "";
	var name =
		shopItem.getElementsByClassName("shop-item-name")[0]?.innerText ||
...
function updateCartTotal() {
	...
	var subtotalElement = document.getElementsByClassName(
