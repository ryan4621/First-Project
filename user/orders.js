...
class OrdersManager {
    ...
    setupEventListeners() {
        ...
        document.getElementById('cancel-close-modal').addEventListener('click', () => {
    ...
    updatePagination() {
        ...
        nextBtn.style.cursor = currentDisplayPage >= totalPages ? 'not-allowed' : 'pointer';
    }
                ...
                <div style="display: flex; justify-content: space-between; align-items: start; flex-wrap: wrap; gap: 15px;">
                    <div>
                        ...
                        <p style="margin: 5px 0;">
                            ...
                            <span class="status-badge status-${order.payment_status}">${this.formatStatus(order.payment_status)}</span>
                        </p>
                    ...
                    <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                        <button class="btn btn-small profile-btn-primary" onclick="ordersManager.viewOrderDetails('${order.order_number}')">
                            View Details
                        </button>
    ...
    canCancel(order) {
        return ['pending', 'processing'].includes(order.status) && order.payment_status === 'paid';
    }
    ...
    displayOrderDetails(data) {
        ...
        modalBody.innerHTML = `
            <div style="margin-bottom: 20px;">
                ...
                <p><strong>Payment Status:</strong> <span class="status-badge status-${order.payment_status}">${this.formatStatus(order.payment_status)}</span></p>
    ...
    async submitCancellation() {
        ...
        try {
            ...
            showToast('Order cancellation requested successfully. Your refund will be processed within 5-7 business days.', 'success')
            this.closeCancelModal();
            await this.loadOrders();
