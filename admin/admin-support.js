...
class SupportManager {
  ...
  renderTickets() {
    ...
    // Update ticket count
    document.getElementById('displayedTicketsCount').textContent = 
      `${this.tickets.length} tickets`;
    
    document.getElementById('totalTicketsInfo').textContent = 
      `Total: ${this.pagination.total} tickets`;
  }
      ...
      <tr>
        ...
        <td>
          <div>
            ...
            <small style="color: #7f8c8d;">${this.truncateText(ticket.message, 50)}</small>
          </div>
        </td>
        <td>
  ...
  generatePageNumbers(totalPages) {
    ...
    for (let page = startPage; page <= endPage; page++) {
      ...
      pageBtn.className = `support-pagination-btn ${page === this.currentPage ? 'active' : ''}`;
      ...
      <div style="display: grid; gap: 1.5rem;">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
          ...
          <div>
            ...
            <p><strong>Subject:</strong> ${this.formatSubject(ticket.subject)}</p>
        ...
        <div style="display: flex; gap: 1rem; justify-content: flex-end; margin-top: 1rem;">
          ...
          <button class="support-btn support-btn-primary" onclick="supportManager.editTicket(${ticket.id})">
            Edit Ticket
          </button>
        </div>
      </div>
